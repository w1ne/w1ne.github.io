...
description: >-
  I am using SourceRabbit Gcode sender to control my "Miyazaki" drawing bot. The
  robot is using CP2102 chip as a virtual com port bridge between USB and cont
date: '2018-03-04'
tags:
  - Linux
  - USB
...
![SourceRabbit G-code Sender](/images/img/04-03-2018/SourceRabbit-G-code-Sender.png)
